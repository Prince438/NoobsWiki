        ...
        >
          ...
          <div>
            <div className="mb-5 flex items-start justify-between">
              ...
              <span className="font-mono text-[9px] tracking-widest text-charcoal/22 pt-1">106 videos</span>
            </div>
            ...
            <p className="mb-7 font-sans text-[12px] leading-relaxed text-charcoal/52">
              AI code editor tutorials covering Cursor setup, Composer, agent workflows, codebase navigation, MCP integrations, real project builds, and productivity tips.
            </p>
          </div>
        ...
        >
          ...
          <div>
            <div className="mb-5 flex items-start justify-between">
              ...
              <span className="font-mono text-[9px] tracking-widest text-charcoal/22 pt-1">108 videos</span>
            </div>
            ...
            <p className="mb-7 font-sans text-[12px] leading-relaxed text-charcoal/52">
              AI coding assistant tutorials covering setup, chat and prompting, coding and refactor workflows, PR reviews, CLI agents, integrations, and productivity tips.
            </p>
          </div>
