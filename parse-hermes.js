...
const inputPath = path.join(__dirname, "hermes-youtube-tutorials.txt");
const outputPath = path.join(__dirname, "src", "data", "hermes-tutorials.json");
...
for (let i = 0; i < lines.length; i++) {
  ...
  // Category header: ## Category Name (N)
